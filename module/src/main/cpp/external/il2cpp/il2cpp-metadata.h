...
struct Il2CppTypeDefinition
{
    ...
    int16_t a12;
    int16_t rgctxStartIndex;
    int16_t rgctxCount;
    int16_t genericContainerIndex;
    int16_t eventStart;
    int16_t propertyStart;
    int16_t nestedTypesStart;

    int16_t interfacesStart;
    int16_t interfaceOffsetsStart;
...
struct Il2CppMethodDefinition
{
    ...
    int16_t genericContainerIndex;
    int16_t invokerIndex;
    int16_t reversePInvokeWrapperIndex;
    int16_t rgctxStartIndex;
    int16_t rgctxCount;
    uint16_t flags;
    uint16_t iflags;
